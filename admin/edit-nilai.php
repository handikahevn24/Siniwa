          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 12</label>
                              <div class="col-sm-10">
                                  <input type="text" name="nilai_tugas12" id="nilai_tugas12" value="<?php echo $data['nilai_tugas12']; ?>" class="form-control" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> SK 13</label>
                              <div class="col-sm-10">
                                  <input type="text" name="nilai_tugas13" id="nilai_tugas13" value="<?php echo $data['nilai_tugas13']; ?>" class="form-control" required="required" />
                              </div>
                          </div>
                          <div class="form-group">
